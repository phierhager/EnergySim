from bems_simulation.core.components.local.battery.actuator import (
    IBatteryActuator,
...
from bems_simulation.core.components.shared.component_outputs import ElectricalEnergy
from bems_simulation.core.components.registry import register_local_component
